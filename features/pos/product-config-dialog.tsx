...
export function ProductConfigDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[480px] rounded-xl p-0 overflow-hidden border-stone-200">
        ...
        <div className="p-6 space-y-6 max-h-[60vh] overflow-y-auto custom-scrollbar">
          {availableVariants.length > 0 && (
            <div className="space-y-3">
              <p className="text-[10px] font-black uppercase tracking-widest text-stone-400">Choose Size (Variant)</p>
          ...
          {availableAddons.length > 0 && (
            <div className="space-y-3">
              <p className="text-[10px] font-black uppercase tracking-widest text-stone-400">Extras & Addons</p>
              <div className="grid grid-cols-2 gap-2">
                {availableAddons.map((a) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex items-center justify-between px-4 py-3 rounded-lg border text-sm font-semibold transition-all text-left",
                        active 
          ...
          {availableModifiers.length > 0 && (
            <div className="space-y-3">
              <p className="text-[10px] font-black uppercase tracking-widest text-stone-400">Special Instructions</p>
        ...
        <DialogFooter className="p-6 bg-stone-50 border-t border-stone-100 flex-row items-center justify-between gap-4">
          <div className="flex flex-col">
            <span className="text-[9px] font-black uppercase tracking-[0.2em] text-stone-400 leading-none mb-1">Total Price</span>
            <span className="text-xl font-black text-stone-950 leading-none">{formatCurrency(finalPrice)}</span>
          </div>
