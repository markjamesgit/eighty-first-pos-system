            ...
            <Table>
              <TableHeader className="bg-stone-50/30">
                <TableRow className="hover:bg-transparent border-stone-100 h-14">
                  ...
                  <TableHead className="text-[10px] font-black uppercase tracking-[0.2em] text-stone-400 text-center">Adjustments</TableHead>
                        ...
                        <TableCell className="text-center">
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <Button
                              ...
                              className="h-9 px-3 text-[10px] font-black uppercase tracking-widest bg-stone-900 text-stone-50 hover:bg-stone-800 transition-all shadow-md active:scale-95"
                            >
                              Commit
                            </Button>
                          </div>
                        ...
                        <TableCell className="text-right pr-8">
                          <div className="flex justify-end gap-2">
                             ...
                             <Button 
                              variant="ghost" 
                              size="icon" 
                              className="h-9 w-9 text-stone-300 hover:text-red-500 hover:bg-red-50 rounded-xl transition-colors border border-stone-200 shadow-sm bg-white" 
