  ...
  return (
    <div className="min-h-screen bg-stone-100">
      <div className="mx-auto grid min-h-screen max-w-[1600px] lg:grid-cols-[240px_1fr]">
        <aside className="sticky top-0 h-screen border-r border-stone-200 bg-white p-4">
          <div className="mb-8 rounded-xl bg-stone-950 p-4 text-white">
            ...
            <p className="mt-2 text-[10px] uppercase font-bold tracking-widest text-stone-500 truncate">{user?.email ?? "Admin"}</p>
          </div>
